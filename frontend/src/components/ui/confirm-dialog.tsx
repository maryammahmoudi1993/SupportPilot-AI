 ...
 * trap, Escape-to-close, focus return to the trigger, and
 * `aria-modal`/background-inert wiring all come from Radix, not
 * hand-rolled here (master prompt Part J §39: "No clickable divs").
 *
